...
var GetInput = /** @class */ (function (_super) {
    ...
    GetInput.prototype.render = function () {
        return (React.createElement("div", { className: "mg-get-input" }, this.getInput()));
    };
    GetInput.prototype.getInput = function () {
        ...
        if (this.props.type === 'select') {
            ...
            input = React.createElement("div", { className: "listBox" },
                React.createElement("div", { className: "listInput" },
                    React.createElement(BaseInput_1.default, { type: "text", name: this.props.name, value: this.state.listText.value, onChange: function (e) {
                ...
                React.createElement("div", { className: "listButton" },
                    React.createElement(reactstrap_1.Button, { color: "primary", size: "sm", onClick: function () {
                            _this.listAddItem();
                        } }, "Ekle")),
                React.createElement("div", { className: "selectedItems" }, this.listSelectedItems()));
        }
        else if (this.props.type === 'radio') {
            input = React.createElement("div", { className: "likeVal" },
                React.createElement(RadioInput_1.default, { name: this.props.name, value: this.state.inputText.value, inline: true, items: this.props.data, idField: "id", textField: "value", onChange: function (e) {
                        _this.handleChange(e);
                    } }),
    ...
    GetInput.prototype.listSelectedItems = function () {
        ...
        if (this.state.listItems.length > 0) {
            this.state.listItems.forEach(function (value, index) {
                items.push(React.createElement("div", { className: "item" },
                    React.createElement("span", null, value),
                    React.createElement("div", { className: "removeItem", onClick: function () {
