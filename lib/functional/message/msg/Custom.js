...
var Custom = /** @class */ (function (_super) {
    ...
    Custom.prototype.getMessageElement = function () {
        return React.createElement("div", { className: "modal fade show-box " + (this.state.show == true ? "show" : ""), style: this.state.show == true ? { display: "block" } : { display: "none" }, id: "exampleModalCenter", tabIndex: -1, role: "dialog", "aria-labelledby": "exampleModalCenterTitle", "aria-hidden": "true" },
            React.createElement("div", { className: "modal-dialog modal-dialog-centered", role: "document" },
                React.createElement("div", { className: "modal-content" },
                    ...
                    React.createElement("div", { className: "modal-footer" }, this.getButtonElement()))));
    };
