...
var ColorInput = /** @class */ (function (_super) {
    ...
    ColorInput.prototype.render = function () {
        ...
        var label = this.props.label != undefined ? React.createElement(Label_1.default, { className: "label-properties" }, this.props.label) : null;
        return React.createElement("div", { className: "mg-input" },
            label,
            React.createElement(BaseInput_1.default, __assign({}, this.props, { className: validColor, onChange: this.___onChange.bind(this), style: { borderColor: validColor } })));
    };
