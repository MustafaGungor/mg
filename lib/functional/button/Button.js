...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        ...
        var child = iconAlign == "left" ?
            React.createElement(reactstrap_1.Button, __assign({}, props, { onClick: this.onClick.bind(this) }),
                React.createElement(FaIcon_1.default, { className: "btn-i", spin: this.state.async, code: this.state.async ? this.state.asyncIcon : this.state.icon }),
                this.props.children) :
            React.createElement(reactstrap_1.Button, __assign({}, props, { onClick: this.onClick.bind(this) }),
                this.props.children,
                React.createElement(FaIcon_1.default, { spin: this.state.async, code: this.state.async ? this.state.asyncIcon : this.state.icon }));
        return child;
    };
