...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.render = function () {
        return (React.createElement("div", { className: "mg-tab " + ((this.props.className !== undefined) ? this.props.className : '') + " " + this.props.color },
        ...
        if (this.props.children) {
            ...
            item.forEach(function (v, i) {
                if (v) {
                    ...
                    body.push(React.createElement(reactstrap_1.TabPane, __assign({}, v.props, { onClick: _this.getClickElement.bind(_this), tabId: i, key: i }), v.props.children));
                }
            });
        }
        return { header: header, body: body };
    };
    Tab.prototype.getClickElement = function (e) {
        // debugger
    };
    Tab.defaultProps = {
        align: 'left',
