...
var LookUp = /** @class */ (function (_super) {
    ...
    function LookUp(props) {
        ...
        _this.returnModal = function () {
            return (React.createElement(reactstrap_1.Modal, { size: 'lg', isOpen: _this.state.modalShow, toggle: _this.toggle },
                React.createElement(reactstrap_1.ModalHeader, { toggle: _this.toggle }, "Se\u00E7im \u0130\u015Flemleri"),
                React.createElement(reactstrap_1.ModalBody, null,
                    React.createElement(DataGrid_1.default, __assign({ fields: _this.props.field, store: _this.props.store, onDoubleSelected: _this.onDoubleClick.bind(_this), onSelected: _this.dataSelected }, _this.props.dataGridOption))),
    ...
    LookUp.prototype.render = function () {
        return (React.createElement("div", { className: "mg-look-up " + this.props.className },
            this.props.label != undefined ? React.createElement("label", { className: "label-properties" }, this.props.label) : null,
            React.createElement("div", { className: "look-up-wrapper" },
                React.createElement("div", { className: "selected-value" },
                    React.createElement("div", { className: "input-val form-control", onClick: this.toggle }, this.renderVal()),
                    React.createElement("div", { className: "show-button" },
                        React.createElement(reactstrap_1.ButtonGroup, null,
                            React.createElement(reactstrap_1.Button, { color: this.props.zommButtonColor, onClick: this.toggle },
                                React.createElement(FaIcon_1.default, { code: this.props.zommButtonIcon })),
                            React.createElement(reactstrap_1.Button, { color: this.props.removeButtonColor, onClick: this.removeSelect, disabled: (this.selectedResult.length > 0) ? false : true },
                                React.createElement(FaIcon_1.default, { code: this.props.removeButtonIcon })))))),
            this.returnModal()));
    };
