...
var FileUpload = /** @class */ (function (_super) {
    ...
    FileUpload.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "mg-file-upload" },
            React.createElement("input", { type: "file", name: "fileInput", ref: function (e) { return _this.fileInput = e; }, onChange: this.getData }),
            React.createElement("div", { className: "select-file", onClick: this.clickFile },
                React.createElement("span", null, "Dosya Se\u00E7iniz")),
            React.createElement("div", { className: "list-images" }, this.renderFile())));
    };
    ...
    FileUpload.prototype.renderFile = function () {
        ...
        this.getFileImage.forEach(function (value, index) {
            items.push(React.createElement("div", { className: "items", key: index },
                React.createElement("div", { className: "close-item", onClick: function (index) { _this.removeItems(index); } },
                    React.createElement(FaIcon_1.default, { code: "fa-times" })),
                React.createElement("div", { className: "image" }, _this.getRenderImage(value)),
                React.createElement("div", { className: "text" },
                    React.createElement("div", { className: "center" },
                        React.createElement("strong", null, value.filesOption.name),
                        React.createElement("span", null, value.filesOption.type),
                        React.createElement("span", null, value.filesOption.size + "KB")))));
        });
        return items;
    };
