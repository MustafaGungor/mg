...
export default class Input extends React.Component<InputProps, any> {
    ...
    render(){ 
        ...
        return(<div {...labelOption} className={"mg-input " + this.props.type + "-input " + this.props.className + ' ' + labelPositionClass + (this.props.icon ? ' left-icon' : '')}>
    ...
    getCheck(inputClass:any, inputProps:any, index?:number){
        return <label className={inputClass + " " + this.props.type + "-item inputtitle"}>
