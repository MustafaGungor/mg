...
var Thead = /** @class */ (function (_super) {
    ...
    Thead.prototype.getItems = function (data, index) {
        ...
        if (data !== undefined) {
            ...
            if (Array.isArray(data)) {
                ...
                returnItem.push(React.createElement("th", { key: index, style: style, className: "" + (active ? 'active' : ''), ref: function (e) { return itemRef_1 = e; } },
    ...
    Thead.prototype.getFilter = function (data, activeType) {
        var _this = this;
        var filterContent;
        filterContent = React.createElement(reactstrap_1.ButtonDropdown, { isOpen: (this.state.filterShowing[data.name] !== undefined && this.state.filterShowing[data.name]) ? this.state.filterShowing[data.name] : false, toggle: function () { _this.filterToggle(data); } },
            React.createElement(reactstrap_1.DropdownToggle, null, (activeType === 'filter' ? React.createElement(FaIcon_1.default, { code: "fa-times", onClick: function () {
                    _this.filterRemove();
    ...
    Thead.prototype.filterRemove = function () {
