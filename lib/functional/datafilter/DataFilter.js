...
var DataFilter = /** @class */ (function (_super) {
        ...
        window.addEventListener('click', function (event) {
            if (_this.state.focusControl.control !== false) {
                ...
                event.path.forEach(function (value) {
                    if (value.className !== undefined && value.className !== "" && value.className.indexOf("mg-data-filter") !== -1) {
                        control_1 = true;
                    }
                });
                if (!control_1) {
    ...
    DataFilter.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "mg-data-filter " + this.props.labelPosition, onClick: function () {
                _this.focusInput();
            } },
            this.labelResult(),
    ...
    DataFilter.prototype.labelResult = function () {
        ...
        if (this.props.label !== undefined) {
            returnLabel = React.createElement("label", { className: "mg-label" }, this.props.label);
        }
        return returnLabel;
    };
    /**
