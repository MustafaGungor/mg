            ...
            React.createElement("div", { className: "toolbar footer" }, (this.props.pageShow !== undefined && this.props.store !== undefined && this.props.store.props.totalCount > 0) ?
                React.createElement("div", { className: "pagination-main" },
                    React.createElement("div", { className: "pagination" },
                        React.createElement(Pagination_1.default, { pageCount: this.props.pageShowCount, size: 'sm', type: "simple", typeShowLength: this.props.pageShow, data: this.props.store.props.totalCount, selectedValue: function (e) {
                                _this.pageChange(e);
                            } })),
                    React.createElement("div", { className: "page-showing" },
                        React.createElement("span", null,
                            React.createElement("strong", null, "G\u00F6sterilen : "),
                            this.props.store.props.pageData.start,
                            " - ",
                            this.props.store.props.pageData.start + this.props.store.props.pageData.limit),
                        React.createElement("span", null,
                            React.createElement("strong", null, "Toplam : "),
                            this.props.store.props.totalCount)))
                : ''));
    };
