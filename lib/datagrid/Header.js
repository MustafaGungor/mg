    ...
    Header.prototype.render = function () {
        ...
        if (data !== undefined) {
            var _loop_1 = function (i) {
                var value = data[i];
                buttons.push(React.createElement(reactstrap_1.Button, { key: i, color: "defaults", size: "sm", disabled: (value.disabled !== undefined ? value.disabled : false), onClick: function () {
