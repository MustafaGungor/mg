...
var DataForm = /** @class */ (function (_super) {
    ...
    DataForm.prototype.render = function () {
        return React.createElement("div", { className: "mg-dataform" },
            ...
            if (val[_this.props.visibilityText] || val[_this.props.visibilityText] === undefined) {
                switch (val[_this.props.typeText]) {
                    ...
                    case "date":
                        ...
                        break;
                    case "dateTime":
                        components.push(React.createElement(reactstrap_1.Col, { key: idx, md: 12 / me.props.col }, me.getDateTimeInput(val)));
                        break;
                    case "time":
                        components.push(React.createElement(reactstrap_1.Col, { key: idx, md: 12 / me.props.col }, me.getTimeInput(val)));
                        break;
                    case "radio":
    ...
    DataForm.prototype.getTextInput = function (value) {
        return React.createElement(TextInput_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], valid: value.isRequired != undefined ? value.isRequired : undefined, onChange: this.handleChange.bind(this) });
    };
    DataForm.prototype.getPasswordInput = function (value) {
        return React.createElement(PasswordInput_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], valid: value.isRequired != undefined ? value.isRequired : undefined, onChange: this.handleChange.bind(this) });
    };
    DataForm.prototype.getNumericInput = function (value) {
        return React.createElement(NumericInput_1.default, { name: value[this.props.nameText], value: this.state[value[this.props.nameText]], label: this.props.label != false ? value[this.props.labelText] : undefined, valid: value.isRequired != undefined ? value.isRequired : undefined, onChange: this.handleChange.bind(this) });
    };
    /**
     ...
     * @returns {any}
     */
    DataForm.prototype.getDateTimeInput = function (value) {
        return React.createElement(DateInput_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], showTimeSelect: true, timeFormat: "HH:mm", timeIntervals: 15, dateFormat: "LLL", timeCaption: "time", onChange: this.handleChange.bind(this) });
    };
    /**
     * DateInput
     * @param value
     * @returns {any}
     */
    DataForm.prototype.getTimeInput = function (value) {
        return React.createElement(DateInput_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], showTimeSelect: true, timeFormat: "HH:mm", showTimeSelectOnly: true, timeIntervals: 15, dateFormat: "LT", timeCaption: "time", onChange: this.handleChange.bind(this) });
    };
    /**
    ...
    DataForm.prototype.getTextArea = function (value) {
        return React.createElement(TextArea_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], valid: value.isRequired != undefined ? value.isRequired : undefined, onChange: this.handleChange.bind(this) });
    };
    /**
     * LookUp component
     * @param value
    ...
    DataForm.prototype.getAlert = function (value) {
        return React.createElement("div", null,
            this.props.label == false ? undefined : React.createElement("label", { className: "label-properties" }, value.title),
    ...
    DataForm.prototype.getColorInput = function (value) {
        return React.createElement(ColorInput_1.default, { name: value[this.props.nameText], label: this.props.label != false ? value[this.props.labelText] : undefined, value: this.state[value[this.props.nameText]], valid: value.isRequired != undefined ? value.isRequired : undefined, onChange: this.handleChange.bind(this) });
    };
