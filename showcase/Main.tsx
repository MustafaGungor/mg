                        ...
                        <Navbar className={`main-menu ${(window.location.hash == "#/")?"active-menu":""}`} expand="md">
                            ...
                            <Collapse isOpen={this.state.isOpen} navbar>
                                <Nav className="ml-auto" navbar>
                                    ...
                                    <NavItem>
                                        <NavLink href="https://github.com/mustafagungor/mg-ui">Github</NavLink>
                                    </NavItem>
                            ...
                            <Container>
                                <Row>
                                    <Col className="footer-left">
                                        <iframe src="https://ghbtns.com/github-btn.html?user=mustafagungor&amp;repo=mg-ui&amp;type=star&amp;count=true" scrolling="0" width="100" height="20px"></iframe>
                                        <iframe src="https://ghbtns.com/github-btn.html?user=mustafagungor&amp;repo=mg-ui&amp;type=fork&amp;count=true" scrolling="0" width="100" height="20px"></iframe>
                                    </Col>
